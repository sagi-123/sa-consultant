...
const SocialLink = ({ href, children, label }: { href: string; children: React.ReactNode; label: string }) => (
  <a
    ...
    aria-label={label}
    className="w-10 h-10 rounded-full glass flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent/50 hover:scale-110 transition-all duration-300"
  >
    {children}
  </a>
);
...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-border/30 pt-6 pb-10 md:py-12 px-4 md:px-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 mb-10">
          <div>
            ...
            <h3 className="text-2xl md:text-4xl font-display font-black tracking-tight logo-text-blue mb-4">SA Consultant & Staffing</h3>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              <SocialLink href={settings.linkedin_url} label="LinkedIn">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 12.073z"/></svg>
              </SocialLink>
              ...
              <SocialLink href={`https://wa.me/${settings.whatsapp_number}`} label="WhatsApp">
